...
namespace Discovery.Characters
{
        ...
        where T : class, new()
    {
        ...
        /// </summary>
        /// <param name="xml">The XML string to deserialize</param>
        /// <param name="settings">XML serialization settings. <see cref="XmlReaderSettings"/></param>
        /// <returns>An object of type <c>T</c></returns>
        ...
        /// </summary>
        /// <param name="source">The object to serialize</param>
        /// <param name="settings">XML serialization settings. <see cref="XmlWriterSettings"/></param>
        /// <returns>A XML string that represents the object to be serialized</returns>
